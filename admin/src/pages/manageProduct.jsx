...
export default function Manageproduct() {
  ...
  const filteredData = dataItems.filter(
    (item) =>
      ...
      item.p_price.toString().toLowerCase().includes(search.toLowerCase())
  );
                  ...
                  <div className="card-datatable text-nowrap">
                    ...
                    >
                      ...
                      <div className="justify-content-between dt-layout-table">
                        <div className="d-md-flex justify-content-between align-items-center col-12 dt-layout-full col-md table table-responsive">
                          <table
